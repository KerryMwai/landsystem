...
<!-- Affordable plots section -->
    <div class="card mt-4 elevation-0" style="border-radius: 0; border: 2px solid white">
        <div class="card-header text-left">
                <h2 class="text-purple text-bold">Articles</h1>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card elevation-2">
                            ...
                            style="
                            background-image: url('../images/img/land10.jpeg');
                    ...
                    <div class="col-4">
                        <div class="card elevation-2">
                            <div class="card-body text-center text-white"
                            style="
                            background-image: url('../images/img/l12.jpeg');
                            background-size:cover;
                            background-repeat:no-repeat;
                            height:18rem
                            "
                    ...
                    <div class="col-4">
                        <div class="card elevation-2">
                            <div class="card-body text-center text-white"
                            style="
                            background-image: url('../images/img/l11.jpeg');
                            background-size:cover;
                            background-repeat:no-repeat;
                            height:18rem
                            "
                            ...
                            <p>Lorem ipsum dolor sit amet.</p>
                                ...
                                <div class="projects">
                                            ...
                                            <div class="project-title2">
                                                <h5 class="land-size">1/12 <sup>th</sup> of an acre</h5>
                                                <h5 class="land-desc">Residential Plots in Luxury</h5>
                                            </div>
                                </div>
                            </div>
                        ...
                        <div class="card elevation-2">
                            ...
                            <p>Lorem ipsum dolor sit amet.</p>
                                ...
                                <div class="projects">
                                            ...
                                            <div class="project-title2">
                                                <h5 class="land-size">1/15 <sup>th</sup> of an acre</h5>
                                                <h5 class="land-desc">Residential Plots in Luxury</h5>
                                            </div>
                                </div>
                            </div>
                        ...
                        <div class="card elevation-2">
                            ...
                            <p>Lorem ipsum dolor sit amet.</p>
                                ...
                                <div class="projects">
                                            ...
                                            <div class="project-title2">
                                                <h5 class="land-size">1/6 <sup>th</sup> of an acre</h5>
                                                <h5 class="land-desc">Residential Plots in Luxury</h5>
                                            </div>
                                </div>
                            </div>
